...
const NavigationItem = ({ item, isActive, onClick, isCollapsed }) => {
  ...
  >
    <Icon
      className={`h-5 w-5 flex-shrink-0 ${isActive ? "text-gray-900" : "text-gray-500"
        }`}
    />
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      {isMobile && sidebarOpen && (
        <div
          className="fixed inset-0 bg-black/10 bg-opacity-25 z-4 backdrop-blur-sm"
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ${isMobile ? 'ml-0' : sidebarCollapsed ? "ml-16" : "ml-64"
        ...
        {/* Top Navbar */}
        <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 stick top-0 z-30">
          <div className="flex items-center space-x-4">
            ...
            <div >
              ...
              <p className="text-sm text-gray-500 hidden sm:block">Her's your invoice overview. </p>
            </div>
          </div>
