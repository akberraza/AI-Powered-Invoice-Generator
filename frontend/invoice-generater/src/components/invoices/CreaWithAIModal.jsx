...
const CreaWithAIModal = ({isOpen, onClose}) => {
...
const handleGenerate = async () => {
  ...
  try {
    ...
    navigete('/invoices/new', {state: {aiData: invoiceData}}) 
       ...
       <div className='bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all'>
        ...
        <div className='space-y-4'>
          <p className='text-sm text-slate-600'>
            Paste any text contains invoice details (like client name, items, quantites, and price) and the AI will attempt to create invoice from it.
          </p>
          <TextareaField 
            name='invoiceText'
            ...
            placeholder="e.g., 'Invoice fro clientCorp: 2 hours or design work at $150/hr and 1 logo for $800"
            row={8}
          />
        </div>
...
export default CreaWithAIModal