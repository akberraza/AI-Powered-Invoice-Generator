      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex items-center justify-between h-16 lg:h-20'>
          ...
          <div className='hidden lg:flex lg:items-center lg:space-x-8 '>
            <a href="#features"
              className='inline-block text-gray-600 hover:text-gray-900 font-medium transition-colors duration-200 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-black after:transition-all after:duration-300 hover:after:w-full'
            >Features</a>
            <a href="#testimonials"
              className='inline-block text-gray-600 hover:text-gray-900 font-medium transition-colors duration-200 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-black after:transition-all after:duration-300 hover:after:w-full'
            > Testimonials</a>
          ...
          <div className='px-2 pt-2 pb-3 space-y-1 sm:px-3'>
            ...
            {isAuthenticated ? (
              ...
              <>
                <Link
                  to='/login'
                  className='block px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-500'
                >Login</Link>
                <Link
                  to='/signup'
