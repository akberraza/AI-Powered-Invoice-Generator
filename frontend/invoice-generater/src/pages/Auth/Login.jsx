          ...
          <div >
            ...
            <div className='relative'>
              ...
              <input
                ...
                onChange={handleInputChange}
                onBlur={handleBlur}
                className={`w-full pl-12 pr-12 py-3 border rounded-lg focus:ring-2 foucs:border-transparent outline-none transition-all ${fieldError.password && touched.password
                  ? "border-red-300 foucs:red-500"
