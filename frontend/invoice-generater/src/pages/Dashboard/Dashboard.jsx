  ...
  return (
    <div className="space-y-8 pb-96">
      ...
      <div>
        ...
        <p className="text-sm text-slate-600 mt-1">A quick of your business finances.</p>
      </div>
      ...
      <div className="w-full bg-white border border-slate-200 rounded-lg shadow-sm shadow-gray-100 overflow-hidden">
        <div className="px-4 sm:px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
          <h3 className="text-lg font-semibold text-slate-900 ">Recent Invoice</h3>
        ...
        {recentInvoices.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-slate-500 mb-6 max-w-md">You haven't create any invoice yet. Get started by creating your first one. </p>
