...
import CreaWithAIModal from '../../components/invoices/CreaWithAIModal';
  ...
  const filteredInvoices = useMemo(() => {
    return invoices
      ...
      .filter(invoice =>
        ...
        invoice.billTo?.clientName?.toLowerCase().includes(searchTerms.toLowerCase())
      );
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='relative w-full'>
              ...
              <input
                ...
                className='w-full h-10 pl-10 pr-4 border border-slate-200 rounded-lg bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500'
                value={searchTerms}
            ...
            <div className='flex-shrink-0'>
              <select
                className='w-full sm:w-auto h-10 px-3 py-2 border border-slate-200 rounded-lg bg-white text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-500'
                value={statusFilter}
